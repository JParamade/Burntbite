...
// A Tigr bitmap.
typedef struct Tigr {
    int iWidth, iHeight;           // width/height (unscaled)
...
void tigrBlit(Tigr *dest, Tigr *src, int dx, int dy, int sx, int sy, int iWidth, int iHeight);
...
// Clips and blends.
void tigrBlitAlpha(Tigr *dest, Tigr *src, int dx, int dy, int sx, int sy, int iWidth, int iHeight, float alpha);
...
// Clips and blends.
void tigrBlitTint(Tigr *dest, Tigr *src, int dx, int dy, int sx, int sy, int iWidth, int iHeight, TPixel tint);
